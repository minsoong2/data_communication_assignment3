...
chunk_size = 256 * 1024
file_path = r'C:\Users\minsoo\OneDrive - 창원대학교\바탕 화면\Data Communication\HW3\file\client4\D.file'
file_collection = []
    ...
    with open("client4.txt", "w", encoding='utf-8') as client_f:
        ...
        try:
            ...
            for idx, match in enumerate(matches):
                ...
                save_file_path = rf'C:\Users\minsoo\OneDrive - 창원대학교\바탕 화면\Data Communication\HW3\file\client4\received_new{idx + 1}.file'
            ...
            download_file_path = r'C:\Users\minsoo\OneDrive - 창원대학교\바탕 화면\Data Communication\HW3\file\client4'
