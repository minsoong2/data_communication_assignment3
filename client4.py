...
chunk_size = 256 * 1024
file_path = r'C:\Users\minsoo\Downloads\file\client4\D.file'
file_collection = []
    ...
    with open(f"client4.txt", "w", encoding='utf-8') as client_f:
        ...
        try:
            ...
            for cs in connected_s_client_socket_list:
                c4_s_thread = threading.Thread(target=send_data, args=(cs, file_path, client_f))
                c4_send_threads.append(c4_s_thread)

            for idx, cs in enumerate(connected_r_client_socket_list):
                save_file_path = rf'C:\Users\minsoo\Downloads\file\client4\received_new{idx + 1}.file'
                c4_r_thread = threading.Thread(target=received_data, args=(cs, save_file_path, client_f))
            ...
            download_file_path = r'C:\Users\minsoo\Downloads\file\client4'
