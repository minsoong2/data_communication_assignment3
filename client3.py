...
chunk_size = 256 * 1024
file_path = r'C:\Users\minsoo\Downloads\file\client3\C.file'
file_collection = []
...
def send_data(c_socket, f_path, f):
    ...
    with open(f_path, 'rb') as file:
        while True:
            ...
            print(f"{formatted_time}: client3 sends chunk")
    ...
    with open("client3.txt", "w", encoding='utf-8') as client_f:
        ...
        try:
            ...
            for cs in connected_s_client_socket_list:
                c3_s_thread = threading.Thread(target=send_data, args=(cs, file_path, client_f))
            ...
            for idx, cs in enumerate(connected_r_client_socket_list):
                ...
                c3_r_thread = threading.Thread(target=received_data, args=(cs, save_file_path, client_f))
            ...
            download_file_path = r'C:\Users\minsoo\Downloads\file\client3'
