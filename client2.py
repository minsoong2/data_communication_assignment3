...
chunk_size = 256 * 1024
file_path = r'C:\Users\minsoo\OneDrive - 창원대학교\바탕 화면\Data Communication\HW3\file\client2\B.file'
file_collection = []
...
def main():
    ...
    with open("client2.txt", "w", encoding='utf-8') as client_f:
        ...
        print(f"{formatted_time}: Client 2 Connected to the server")
        client_f.write(f"{formatted_time}: Client 2 Connected to the server" + '\n')
        ...
        try:
            ...
            for idx, match in enumerate(matches):
                ...
                save_file_path = rf'C:\Users\minsoo\OneDrive - 창원대학교\바탕 화면\Data Communication\HW3\file\client2\received_new{idx + 1}.file'
            ...
            download_file_path = r'C:\Users\minsoo\OneDrive - 창원대학교\바탕 화면\Data Communication\HW3\file\client2'
            ...
            having_md5_info = f"{formatted_time}: client2 md5 - {having_md5_list[0]}, {having_md5_list[1]}, {having_md5_list[2]}, {having_md5_list[3]}"
            print(having_md5_info)
            client_f.write(having_md5_info + '\n')
            client_socket.send(having_md5_info.encode())

        except ConnectionResetError:
            msg = f"Client 2: Connection was forcibly closed."
            print(msg)
